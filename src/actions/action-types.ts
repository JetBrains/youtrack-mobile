...
export const RECEIVE_USER_APPEARANCE_PROFILE =
  'app.RECEIVE_USER_APPEARANCE_PROFILE';
export const RECEIVE_USER_ARTICLES_PROFILE =
  'app.RECEIVE_USER_ARTICLES_PROFILE';

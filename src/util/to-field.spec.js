...
describe('toField', () => {
  ...
  it('should support nested fields', () => {
    ...
    ]).toString()).toEqual('id,project(id),user(avatar(url),id)');
  });
  ...
  it('should support inner braced string in array', () => {
    expect(toField([{
      field: ['value(id)'],
    }]).toString()).toEqual('field(value(id))');
  });
  ...
  it('should ignore empty string', () => {
    ...
    expect(field.getNormalizedFields()).toEqual({id: null});
  ...
  it('should allow remove fields', () => {
    expect(toField([
      ...
      'type',
      'name',
    ]).exclude('name').toString()).toEqual('id,type');
  });
  ...
  it('should remove whole sub-field when it is wrapped to array', () => {
    ...
    expect(toField([
      ...
      'type',
      subfield,
    ]).exclude([subfield]).toString()).toEqual('id,type');
  });
  ...
  it('should exclude whole object', () => {
    ...
    ]).exclude(excludeFields).toString()).toEqual('type');
  });
  ...
  it('should exclude part of object', () => {
    ...
    ]).exclude(excludeFields).toString()).toEqual('subtasks(trimmedIssues(id,smt)),type');
  });
  ...
  describe('zip', () => {
    ...
    it('should show example where zip algorithm would not produce the best solution', () => {
      ...
      expect(zip('foo(id,type,name,time),id,type,name,time,bar(id,type,name)'))

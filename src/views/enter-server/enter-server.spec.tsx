...
describe('EnterServer', () => {
  ...
  let connectToYouTrack: jest.Mock;
  let onCancel: jest.Mock;
  let connectPromise: Promise<Object>;
  beforeEach(() => {
  ...
  describe('EnterServer', () => {
    let instance: EnterServer;
    beforeEach(() => {
      instance = new EnterServer({serverUrl: ''});
    });
    ...
    describe('isValidInput', () => {
      ...
      function createInstance(serverUrl: string) {

...
export const confirmDeleteArticle = (message?: string): any => (
  confirmation(i18n('Are you sure you want to delete this article?'), deleteButtonText, message)
);

export const confirmDeleteArticleDraft = (message?: string): any => (
  confirmation(i18n('Are you sure you want to delete this draft?'), deleteButtonText, message)
);

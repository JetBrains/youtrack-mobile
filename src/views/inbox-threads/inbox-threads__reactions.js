...
export default function InboxThreadReaction({
  ...
  const issue: AnyIssue = thread.subject.target.issue;

  return (
    <View style={style}>
      <InboxIssue
        issue={issue}
        onNavigateToIssue={() => Router.Issue({issueId: issue.id, navigateToActivity: true})}
      ...
      <View>
        <View style={styles.row}>
          <View style={styles.threadTitleIcon}>
            <ReactionIcon name={reaction.reaction} size={16}/>

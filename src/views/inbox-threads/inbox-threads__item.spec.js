...
describe('Inbox Threads Item', () => {
  ...
  it('should not render merged activities', () => {
    ...
    expect(() => getByTestId('test:id/inboxThreadItemMergedActivities')).toThrow();
  });
  ...
  it('should render merged activities', () => {
    ...
    expect(getByTestId('test:id/inboxThreadItemMergedActivities')).toBeDefined();
  });
  ...
  it('should not invoke a callback `onNavigate` if it is not provided', () => {
    ...
    const {getByTestId} = doRender({onNavigate});
  ...
  it('should navigate to change button if `onNavigate` callback is not provided', () => {
    ...
    expect(getByTestId('test:id/inboxThreadItemNavigateButton')).not.toBeDisabled();

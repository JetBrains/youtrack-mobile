...
export const START_LOADING_COMMENT_SUGGESTIONS =
  'issue.START_LOADING_COMMENT_SUGGESTIONS';
export const STOP_LOADING_COMMENT_SUGGESTIONS =
  'issue.STOP_LOADING_COMMENT_SUGGESTIONS';
...
export const RECEIVE_ACTIVITY_API_AVAILABILITY =
  'issue.RECEIVE_ACTIVITY_API_AVAILABILITY';
...
export const SET_HELPDESK_DEFAULT_PROJECT_TEAM = 'issue.SET_HELPDESK_DEFAULT_PROJECT_TEAM';

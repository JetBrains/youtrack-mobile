...
export const attachmentTypes: typeof attachmentActionMap = createAttachmentTypes(modalIssueNamespace);
export const attachmentActions: AttachmentActions = getAttachmentActions(modalIssueNamespace);

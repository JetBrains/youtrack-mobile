...
describe('BoardScroller', () => {
  ...
  describe('snapping to apropriate point', () => {
    ...
    it('should snap to last column even if moving to next', () => {
      ...
      event.nativeEvent.velocity.x = 2;
      getSnapToX(event, columns).should.equal(1940.5);
    });
  });
});
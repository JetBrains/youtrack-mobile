...
describe('IssuePermissions', function () {
  ...
  describe('isCurrentUser', () => {
    ...
    it('should return FALSE if a passed user is not a current user', () => {
      issuePermissions.isCurrentUser({
        ringId: 'foo',
      }).should.be.false;
    });
  ...
  describe('canStar', () => {
    ...
    it('should not allow to add Star tag', () => {
      issuePermissions = createInstance(permissionsMock, {
        currentUserMock,
        ...{
          guest: true,
        },
  ...
  describe('Article attachment', () => {
    ...
    it('should not allow to add an attachment', () => {
      ...
      expect(issuePermissions.articleCanAddAttachment(issueMock)).toEqual(
        false,
      );
    });
    it('should allow to delete an attachment', () => {
      mockPermissionsHas(UPDATE_ARTICLE, true);
      expect(issuePermissions.articleCanDeleteAttachment(issueMock)).toEqual(
        true,
      );
    });

  ...
  describe('ytDate', () => {
    ...
    describe('Absolute dates', () => {
      describe('absDate', () => {
        ...
        it('should return abs date - 2 min before', () => {
          expect(absDate(new Date(0) - 60 * 1000 * 2)).toEqual(
            '1 Jan 1970 00:58',
          );
        });
      });
      describe('default format', () => {
        beforeEach(() => {
          storage.getStorageState.mockReturnValue(createStorageStateMock());
        });
    ...
    describe('Relative dates', () => {
      ...
      it('should return date in hours', () => {
        expect(ytDate(Date.now() - 60 * 1000 * 60 * 2)).toEqual(
          'about 2 hours ago',
        );
      });
      it('should return date in years', () => {
        expect(ytDate(Date.now() - 60 * 1000 * 60 * 24 * 366)).toEqual(
          'about 1 year ago',
        );
      });
    });

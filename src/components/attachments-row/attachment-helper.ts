...
const attachment_ATTACH_RECEIVE_ALL_ATTACHMENTS =
  'attachment.ATTACH_RECEIVE_ALL_ATTACHMENTS';
...
const attachment_ATTACH_TOGGLE_ADD_FILE_DIALOG =
  'attachment.ATTACH_TOGGLE_ADD_FILE_DIALOG';
...
export const createAttachmentTypes = function (
  prefix: string,
): typeof attachmentActionMap {
  const attachmentTypes: Record<string, any> = {};
  Object.entries(attachmentActionMap).forEach(function (
    entry: $TupleMap<any, any>,
  ) {
